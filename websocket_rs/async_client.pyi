...
class ClientConnection:
    ...
    def send_nowait(self, message: str | bytes) -> None:
        """Fire-and-forget send: enqueues synchronously without producing an awaitable.

        Skips the Future/await round-trip for tight pipelined loops.
        Raises BlockingIOError if the internal send queue is full — callers
        should fall back to ``await send(...)`` to apply backpressure.
        """
        ...
